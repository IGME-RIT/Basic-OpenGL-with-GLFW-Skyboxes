...
int main(int argc, char **argv)
{
    ...
    skyBoxVertexShader.InitFromFile("../shaders/skyboxVertex.glsl", GL_VERTEX_SHADER);
    skyBoxFragmentShader.InitFromFile("../shaders/skyboxFragment.glsl", GL_FRAGMENT_SHADER);
